...
function insertPiattoInOrdine(piatto)
{
	...
	createCookie("resto",prez_tot_obj.value,0);
}
  ...
  <div class="gestOrdini_toolBar"  > 
	...
	<div class="gestOrdini_piatti"  >
      ...
      <td  align="right"> 
            ...
            <tr>
            <td colspan="6">
            	<button name="primo1" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("primo",1)'>
   					<img  src="gfx/spaghetti-48x48.png"  class="iconaPiatto" \>
   					<?php getPiatti_FastButt("Primo",1); ?>
 				</button> 
            	
                <button name="primo2" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("primo",2)'>
   					<img  src="gfx/spaghetti-48x48.png"  class="iconaPiatto" \>
   					<?php getPiatti_FastButt("Primo",2); ?>
 				</button> 
                
                <button name="primo3" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("primo",3)'>
   					<img  src="gfx/spaghetti-48x48.png"  class="iconaPiatto" \>
   					<?php getPiatti_FastButt("Primo",3); ?>
 				</button> 
            	
                <button name="primo4" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("primo",4)'>
   					<img  src="gfx/spaghetti-48x48.png"  class="iconaPiatto" \>
      ...
      <td  align="right"> 
        ...
        <tr>
            <td colspan="6">
            	<button name="secondo1" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("secondo",1)'>
   					<img  src="gfx/cutlet-48x48.png"  class="iconaPiatto" \>
   					<?php getPiatti_FastButt("Secondo",1); ?>
 				</button> 
            	
                <button name="secondo2" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("secondo",2)'>
   					<img  src="gfx/cutlet-48x48.png"  class="iconaPiatto" \>
   					<?php getPiatti_FastButt("Secondo",2); ?>
 				</button> 
                
                <button name="secondo3" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("secondo",3)'>
   					<img  src="gfx/cutlet-48x48.png"  class="iconaPiatto" \>
   					<?php getPiatti_FastButt("Secondo",3); ?>
 				</button> 
            	
                <button name="secondo4" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("secondo",4)'>
   					<img  src="gfx/cutlet-48x48.png"  class="iconaPiatto" \>
     ...
     <td  align="right"> 
        ...
        <tr>
            <td colspan="6">
            	<button name="contorno1" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("contorno",1)'>
   					<img src="gfx/sliced-bread-48x48.png"  class="iconaPiatto">
   					<?php getPiatti_FastButt("Contorno",1); ?>
 				</button> 
            	
                <button name="contorno2" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("contorno",2)'>
   					<img src="gfx/sliced-bread-48x48.png"  class="iconaPiatto">
   					<?php getPiatti_FastButt("Contorno",2); ?>
 				</button> 
                
                <button name="contorno3" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("contorno",3)'>
   					<img src="gfx/sliced-bread-48x48.png"  class="iconaPiatto">
   					<?php getPiatti_FastButt("Contorno",3); ?>
 				</button> 
            	
                <button name="contorno4" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("contorno",4)'>
   					<img src="gfx/sliced-bread-48x48.png"  class="iconaPiatto">
      ...
      <td  align="right"> 
         ...
         <tr>
            <td colspan="6" valign="middle">
            	<button name="bibite1" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("bibite",1)'>
   					<img src="gfx/beer-48x48.png"  class="iconaPiatto">
   					<?php getPiatti_FastButt("Bibita",1); ?>
 				</button> 
            	
                <button name="bibite2" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("bibite",2)'>
   					<img src="gfx/beer-48x48.png"  class="iconaPiatto">
   					<?php getPiatti_FastButt("Bibita",2); ?>
 				</button> 
                
                <button name="bibite3" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("bibite",3)'>
   					<img src="gfx/beer-48x48.png"  class="iconaPiatto">
   					<?php getPiatti_FastButt("Bibita",3); ?>
 				</button> 
            	
                <button name="bibite4" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("bibite",4)'>
   					<img src="gfx/beer-48x48.png"  class="iconaPiatto">
     ...
     <td width="18%" > 
        ...
        <tr>
            <td colspan="6" valign="middle">
            	<button name="dessert1" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("dessert",1)'>
   				<img src="gfx/coffee-cup-48x48.png"  class="iconaPiatto" >
   					<?php getPiatti_FastButt("Dessert",1); ?>
 				</button> 
            	
                <button name="dessert2" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("dessert",2)'>
   					<img src="gfx/coffee-cup-48x48.png"  class="iconaPiatto" >
   					<?php getPiatti_FastButt("Dessert",2); ?>
 				</button> 
                
                <button name="dessert3" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("dessert",3)'>
   					<img src="gfx/coffee-cup-48x48.png"  class="iconaPiatto" >
   					<?php getPiatti_FastButt("Dessert",3); ?>
 				</button> 
            	
                <button name="dessert4" type="button" style="width:200;height:50" onClick='insertFastButtonInOrdine("dessert",4)'>
   					<img src="gfx/coffee-cup-48x48.png"  class="iconaPiatto" >
...
<div id="logo_coperti" class="plogoCoperti"  > 
    ...
    <form id="form_resto" style="font-size:10">
		...
		cont.<INPUT id="contanti" type="text" size="5" style="font-size:10">
